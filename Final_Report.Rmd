...
knitr::include_graphics("Images/Excel III.jpg")
```


```{r, out.width = "80%", fig.align = "center"}
knitr::include_graphics("Images/R.verson of table.jpg")
```
...
```{r, out.width = "80%", fig.align = "center"}
knitr::include_graphics("Images/Søkeord i R.jpg")
```
...
save(keyword_subset, file = "cleaned docs/keyword_subset.Rdata")
